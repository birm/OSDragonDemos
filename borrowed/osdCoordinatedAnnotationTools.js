...
var annotools = function (options) {
  this.AnnotationStore = delayer({})//new AnnotationStore(options.iid)

  this.annotationActive = false //isAnnotationActive()
  ...
  this.context_list = options.context_list || []; // context_list should be a set of ids of already initalized canvases
  ...
  this.annotationHandler = delayer({})//options.annotationHandler || new AnnotoolsOpenSeadragonHandler()
  /*
